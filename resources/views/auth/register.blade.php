    ...
    <div class="w-4/12 bg-white p-6 rounded-lg">
      <form action="{{ route('register') }}" method="post">
        ...
        <div class="mb-4">
          ...
          <input type="text" name="password" id="password" placeholder="Enter your password..." class="bg-gray-100 border-2 w-full p-4 rounded-lg" value="">
        </div>
        <div class="mb-4">
          <label for="repeat_password" class="sr-only">Repeat your password</label>
          <input type="text" name="repeat_password" id="repeat_password" placeholder="Repeat your password..." class="bg-gray-100 border-2 w-full p-4 rounded-lg" value="">
        </div>
        <div>
